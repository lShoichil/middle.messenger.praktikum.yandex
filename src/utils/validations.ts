...
export const VALIDATION_ERRORS: Record<string, string> = {
  ...
  email:
    'Латиница, может включать цифры и знаки "_" и "-", обязательно должна "@" и точка после неё, перед точкой обязательно должны быть буквы.',
  ...
  password_confirm:
    'Длина от 8 до 40 символов, обязательно хотя бы одна заглавная буква и цифра. Или пароли не совпадают'
};
