...
export default class ChatInput extends Block<Props> {
  constructor(props: Props) {
    super({
      ...props,
      onSend: (e: Event) => {
        e.preventDefault();
        const message = (this.refs.message as Input).value();
  ...
  render() {
    ...
    <div class="chat-input">
      ...
      <input type="text" class="chat-input-field" placeholder="Сообщение" />
